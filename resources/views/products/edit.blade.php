    ...
    <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-8">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-600 text-sm mt-2">Update product information</p>
            </div>
            ...
            <form action="{{ route('product.update', ['product' => $product]) }}" method="POST" class="space-y-5" autocomplete="off">
                @csrf
                @method('PUT')
